...
config.keys = {
    ...
    { key = "|",  mods = "ALT|CTRL|SHIFT", action = wezterm.action.SplitVertical }, -- splits into two panes top to bottom (horizontally)
    { key = "\\", mods = "ALT|CTRL",       action = wezterm.action.SplitHorizontal }, -- splits into two panes side by side (vertically)

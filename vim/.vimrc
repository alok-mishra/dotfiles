...
set tabstop=2       " how many spaces an actual tab shows
set softtabstop=2   " how many spaces a tab uses in insert mode
set shiftwidth=2    " how many spaces a tab uses when shifting << >>
